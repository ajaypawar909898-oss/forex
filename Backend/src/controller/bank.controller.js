...
//     /* ===============================
//        1️⃣ Get existing bank record
//     =============================== */
//     const [existingRows] = await db.execute(
//       "SELECT qr_code FROM bank_details WHERE id = ?",
//       [id],
//     );
...
//     const oldQrImage = existingRows[0].qr_code;

//     /* ===============================
//        2️⃣ Decide image to save
//        → New image OR old image
//     =============================== */
//     const newQrImage = req.files?.qr_image?.[0]?.path;
//     const finalQrImage = newQrImage || oldQrImage;
